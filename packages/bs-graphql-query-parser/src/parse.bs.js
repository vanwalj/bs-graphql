...
var Lexer$BsGraphqlQueryParser = require("./lexer.bs.js");
var Parser$BsGraphqlQueryParser = require("./parser.bs.js");
...
function parse(s) {
  ...
  try {
    return /* Ok */Block.__(0, [Parser$BsGraphqlQueryParser.read_document(Lexer$BsGraphqlQueryParser.read, lexbuf)]);
  }
  catch (raw_exn){
    var exn = Js_exn.internalToOCamlException(raw_exn);
    if (exn[0] === Lexer$BsGraphqlQueryParser.$$SyntaxError) {
      return /* Error */Block.__(1, [/* SyntaxError */Block.__(0, [/* tuple */[
                      get_position(lexbuf),
                      exn[1]
                    ]])]);
    } else if (exn === Parser$BsGraphqlQueryParser.$$Error) {
